        ...
        <>
            <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl bg-black/30 border-b border-cyan-500/10">
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <button
                        ...
                        className="px-5 py-2 rounded-xl bg-cyan-400 text-black font-black hover:scale-105 hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-all"
                    >
                        LOGIN
                    </button>
            ...
            {open && (
                <div onClick={() => setOpen(false)}>
                    ...
                    <LoginModal closeModal={() => setOpen(false)} />
